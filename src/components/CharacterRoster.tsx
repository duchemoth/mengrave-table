              ...
              {activeTab === "skills" && (
                <section className="character-editor-section">
                  ...
                  <h3 className="character-section-title">
                    Скоро здесь будут 24 навыка
                  </h3>

                  <p className="character-help-text">
                    Следующим шагом добавим список навыков из игрового ядра,
                    счётчик стартовых очков 0/12 и быстрые кнопки −/+.
                  </p>
                  ...
                  <label className="character-field wide">
                    ...
                    <textarea
                      ...
                      placeholder="Например: Стрельба — пистольверы; Ремонт — комген..."
                    />
                  </label>
